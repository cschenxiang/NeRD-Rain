...
|:-----: |:-----: |:-----: |
| [model_a.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/model_a.py) | [Google Drive](https://drive.google.com/file/d/1HxUORMtck4OvxlSj0lTKy_vzIqs7y9_q/view?usp=sharing) | a, see Table 3. |
| [model_b.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/model_b.py) | [Google Drive](https://drive.google.com/file/d/1QXsCNr40Qmzs7_FE2d4rC-ORdfMKrZlf/view?usp=sharing) | b, see Table 3. |
| [model_d.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/model_d.py) | [Google Drive](https://drive.google.com/file/d/1LM7uPOdVfZiiF28DDN4sNRhsOlu9rr8W/view?usp=sharing) | d, see Table 3. |
| [model_e.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/model_e.py)+[mlp_e.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/mlp_e.py) | [Google Drive](https://drive.google.com/file/d/13iud0pjqYOB9MLtTMiAsDLRso_DqW14E/view?usp=sharing) | e, see Table 3. |
| [model_f.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/model_f.py)+[mlp_f.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/mlp_f.py) | [Google Drive](https://drive.google.com/file/d/1H-g7CG1GtkXzVUWMQZiRByZurq7GEdnL/view?usp=sharing) | f, see Table 3. |
| [model_g.py](https://github.com/cschenxiang/NeRD-Rain/blob/main/Ablations/model_g.py) | [Google Drive](https://drive.google.com/file/d/1cVyGd9ndLkLW8Tjjz7DYyGC7EEP9eGYJ/view?usp=sharing) | g, see Table 3. |
